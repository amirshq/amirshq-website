...
- **Open the site**: Visit the GitHub Pages deployment or open `index.html` directly in your browser to see the main landing page.
- **Explore sections**: From the landing page, navigate to the Photography portfolio and LearnAIbyAmir hub to see how content and layouts are organized.
...
You can also access the live site at [`https://amirshq.com`](https://amirshq.com).